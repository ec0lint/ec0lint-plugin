...
final class CliBuilder {
    ...
    @NotNull
    static GeneralCommandLine create(@NotNull Ec0lintRunner.Ec0lintSettings settings) {
        return NodeRunner.createCommandLine(settings.cwd, settings.node, settings.ec0lintExecutablePath);
    }

    @NotNull
    static GeneralCommandLine createLint(@NotNull Ec0lintRunner.Ec0lintSettings settings) {
    ...
    @NotNull
    static GeneralCommandLine createFix(@NotNull Ec0lintRunner.Ec0lintSettings settings) {
    ...
    @NotNull
    static GeneralCommandLine createVersion(@NotNull Ec0lintRunner.Ec0lintSettings settings) {
        GeneralCommandLine commandLine = create(settings);
