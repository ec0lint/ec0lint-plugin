...
public final class Ec0LintConfigFileUtil {
    ...
    public static boolean isESLintConfigFile(JSFile file) {
        return file != null && (isESLintConfigFile(file.getVirtualFile()) || file.getFileType().equals(Ec0LintConfigFileType.INSTANCE));
    }

    private static Set<String> createSet() {
        Set<String> s = new HashSet<String>();
        Collections.addAll(s, Ec0LintConfigFileType.ESLINTRC_FILES);
        return s;
    }
